...
def example_mgrm_step_mc():
    """多维 mgrm_step 模型mc方法示例"""
    print("\n" + "=" * 50)
    print("多维 mgrm_step 模型mc方法示例")
    print("=" * 50)
    # 生成模拟数据
    n_subjects = 1000
    n_items = 30
...
def example_mgrm_stand_mc():
    """多维 mgrm_stand 模型mc方法示例"""
    print("\n" + "=" * 50)
    print("多维 mgrm_stand 模型mc方法示例")
    print("=" * 50)
    # 生成模拟数据
    n_subjects = 1000
    n_items = 30
...
if __name__ == "__main__":
    ...
    # 运行mcem算法多维2pl示例
    true_a, true_d, true_theta, a_est, d_est, theta_est = example_m2pl_mc()
    # 绘制结果（如果有 matplotlib）
    ...
    # 运行mc算法多维mgrm_step示例
    true_a, true_d, true_theta, a_est, d_est, theta_est = example_mgrm_step_mc()
    # 绘制结果（如果有 matplotlib）
    ...
    # 运行mc算法多维mgrm_stand示例
    true_a, true_d, true_theta, a_est, d_est, theta_est = example_mgrm_stand_mc()
    # 绘制结果（如果有 matplotlib）
